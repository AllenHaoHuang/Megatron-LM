...
def _add_network_size_args(parser):
    ...
    group.add_argument('--ssslu', action='store_true',
                       help='Use SSSLU activation')
    group.add_argument('--xssslu', action='store_true',
                       help='Use xSSSLU activation')
    group.add_argument('--sssglu', action='store_true',
                       help='Use SSSGLU activation')
    ...
    group.add_argument('--nxpr', action='store_true',
                       help='Use NXPR activation')
    group.add_argument('--ngxpr', action='store_true',
                       help='Use NGXPR activation')
