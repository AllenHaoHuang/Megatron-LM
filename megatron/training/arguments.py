...
from megatron.training.activations import squared_relu, XIELU, XSSSLUR2, XSSSLUPR3
...
def core_transformer_config_from_args(args, config_class=None):
    ...
    activation_flags = [args.swiglu, args.squared_relu, args.xielu, args.xssslur2, args.xssslupr3]
    ...
    if args.xssslupr3:
        kw_args['activation_func'] = XSSSLUPR3
...
def _add_network_size_args(parser):
    ...
    group.add_argument('--xielu', action='store_true',
                       help='Use xielu activation, an extension of squared relu to handle negative inputs')
    group.add_argument('--xssslur2', action='store_true',
                       help='Use xssslur2 activation, a more efficient xielu')
    group.add_argument('--xssslupr3', action='store_true',
                       help='Use xssslupr3 activation, replace relu squared of xssslur2 with 3-order polyrelu')
