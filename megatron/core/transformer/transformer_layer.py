    ...
    def _forward_attention(
        ...
        *,
        ...
        if not isinstance(self.post_self_attn_layernorm, IdentityOp):
            attn_out = apply_module(self.post_self_attn_layernorm)(attention_output_with_bias[0])
            # Preserve the (output, bias) tuple shape expected by BDA.
            attention_output_with_bias = (attn_out, attention_output_with_bias[1]) + tuple(
                attention_output_with_bias[2:]
            )
