...
from megatron.core.activations import XIELU, XSSSLUR2, SSSLU, XSSSLU, SSSGLU, XSSSGLU, GXSSSLUR2, PolyReLU, PolyNorm, XSSSLUPR, GXSSSLUPR
...
class MLP(MegatronModule):
    ...
    def __init__(
        ...
        # Post-activation norm (local import to avoid circular import)
